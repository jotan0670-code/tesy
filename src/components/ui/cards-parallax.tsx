...
const Card: FC<iCardProps> = ({
	...
	return (
		<div className="h-[70vh] flex items-center justify-center sticky top-0 md:p-0 px-4">
			<div
				className="relative flex flex-col h-[280px] w-full max-w-[600px] py-12 px-10 md:px-12
